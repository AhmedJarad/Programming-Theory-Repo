...
using UnityEngine;
using TMPro;
public class CheckerInputs1 : MonoBehaviour
{
   ...
   public Animator anim;
    ...
    void Timer()
    {
        ...
        if (timer < 0.2)
        {
            ...
            if (rb != null)
            {
                rb.GetComponent<Rigidbody>().AddForce(Vector3.right * (rb.transform.position.x - anim.transform.position.x), ForceMode.Impulse);
            }
